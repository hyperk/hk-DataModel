...
\index{Utilities@{Utilities}!CreateThread@{CreateThread}}
\index{CreateThread@{CreateThread}!Utilities@{Utilities}}
\doxysubsubsection{\texorpdfstring{CreateThread()}{CreateThread()}}
{\footnotesize\ttfamily \mbox{\hyperlink{structThread__args}{Thread\+\_\+args}} $\ast$ Utilities\+::\+Create\+Thread (\begin{DoxyParamCaption}\item[{std\+::string}]{Thread\+Name,  }\item[{void($\ast$)(\mbox{\hyperlink{structThread__args}{Thread\+\_\+args}} $\ast$)}]{func,  }\item[{\mbox{\hyperlink{structThread__args}{Thread\+\_\+args}} $\ast$}]{args }\end{DoxyParamCaption})}
